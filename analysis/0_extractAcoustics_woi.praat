...
# will cut of beginning, 'pc', and last tab (which is f linger internal and irrelevant)
...
#	sentence Name_Format participant_presentationnum_verb_condition_item_targword_question_yesno_list_version_index
	sentence Result_filename measure_nonrhyming_84total_60No_24Yes_20181210
#	sentence extension .wav
  sentence Sound_directory /Users/xzfang/Desktop/prosody_study_data/nonrhyming_84total_60No_24Yes_20181210/responses_to_analyze/
  sentence Textgrid_dir /Users/xzfang/Desktop/prosody_study_data/nonrhyming_84total_60No_24Yes_20181210/responses_to_analyze_textgrid/
  # sentence Sound_directory C:\Users\14868\Desktop\Ted\stressturk_recordings_20181210\2_data\1_soundfiles\
	# sentence Sound_directory /Users/PUT_PATH_HERE/stressTurk #stressTurk_recordings_20181210/2_data/1_soundfiles/
	natural phoneTier 1
	natural wordTier 2
	natural woiTier 2
	sentence seperator ,
...
strings = Create Strings as file list... list 'sound_directory$'*'extension$'
appendInfoLine: strings
appendInfoLine: "sound directory:"
appendInfoLine: sound_directory$
#appendInfoLine: "extension:"
#appendInfoLine: extension$
n = Get number of strings
#
#appendInfoLine: "total number of .wav files presented"
#   appendInfoLine: n
...
#cindy
printline Soundfiles presented: 'i'
   #appendInfoLine: i
#
   ...
   dummy$ = left$(filename$, length)
     ...
     call cutname 'dummy$'
grid$ = textgrid_dir$+dummy$+".TextGrid"
