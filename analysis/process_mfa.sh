...
current_exp=audio_for_exp14_06_19_20.
...
$my_praat_location --run extract_subject_Acoustics_woi.praat measure_$current_exp $current_data_dir/responses_to_analyze/ $current_data_dir/responses_to_analyze_textgrid/responses_to_analyze_mfa/ 1 2 2 ","

# $my_praat_location --run extract_questioner_Acoustics_woi.praat measure_$current_exp $current_data_dir/responses_to_analyze/ $current_data_dir/responses_to_analyze_textgrid/responses_to_analyze_mfa/ 1 2 2 ","
