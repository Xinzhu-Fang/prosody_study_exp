...
for (iF in features){
  ...
  print(
    ggplot(summarized_dataset, aes(x=Location, y=get(iF), fill=condition)) + 
          ...
          ggtitle(paste0('Effect of contrast on ', iF, ' (noncontrastive from yes)'))
    )
  ...
  print(
    ggplot(summarized_dataset, aes(x=Location, y=get(iF), fill=condition)) + 
          ...
          scale_fill_hue(name="location_condition", 
                         breaks=c("Control", "contrast"),
                         labels=c("NonContrastive", "Contrastive")) +
          ggtitle(paste0('Effect of contrast on ', iF, ' (noncontrastive from other no conditions)'))
    )
